...
###############################################################################
    ...
    # Load excel
    df=pd.read_excel('data/Dogecoin Historical Data.xlsx')
    print(df.head)
    ...
    # Save or print
    print(result.head())
    result.to_excel('data/Dogecoin_LastOfMonth.xlsx', index=False)
...
# #For Ethereum
#     # Load excel
#     df=pd.read_excel('data/Ethereum Historical Data.xlsx')
...
#     # Save or print
#     print(result.head())
#     result.to_excel('data/Ethereum_LastOfMonth.xlsx', index=False)
